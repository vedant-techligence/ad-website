...
function Onboarding() {
  ...
  const handleFinish = async (event) => {
    ...
    try {
      ...
      // keep auth consistent with login flow
        ...
        {step === 1 ? (
          <>
            ...
            <p className="onboarding-subtitle">
              Finish your company setup and we will provision demo campaigns,
              reports, notifications, and geo analytics automatically.
            </p>
